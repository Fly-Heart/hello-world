...
IBM® InfoSphere® Information Server documentation on the media
==============================================================

Where to start:
---------------

- To get started with the product, view the Quick Start Guide:
    <media_root>/IS_Quick_Start_Guide_113.pdf

- To access PDF documentation, view the Bookshelf:
    <media_root>/Documentation/bookshelf_<lang>.html

- You can access online documentation in the IBM Knowledge Center:
    http://www.ibm.com/support/knowledgecenter/SSZJPZ_11.3.0

  However, if you do not have access to the internet, then to install the
  online documentation on a local IBM AIX, Linux, or Microsoft Windows
  computer, view the information center readme:
    <media_root>/Documentation/information_center/readme.html
...
IBM Director of Licensing  Legal and Intellectual Property Law  IBM Japan Ltd.
19-21, Nihonbashi-Hakozakicho, Chuo-ku  Tokyo 103-8510, Japan  The following
